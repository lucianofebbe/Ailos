using AilosInfra.Apis.ApiExternal;
using AilosInfra.Apis.ApiExternal.ApiExternal;
using AilosInfra.Interfaces.Apis.ApiExternal.ApiExternal;
using AilosInfra.Interfaces.Apis.ApiExternal.ApiExternalFactory;

namespace AilosInfra.Apis.ApiExternal.ApiExternalFactory
{
    /// <summary>
