...
namespace AilosInfra.Mappers.AutoMapper.Mapper
{
        ...
        where Origin : class
    {
        ...
        public Task<List<Origin>> MapperItemToListAsync(Destiny? item)
        {
            throw new NotImplementedException();
        }

        public Task<List<Destiny>> MapperItemToListAsync(Origin? item)
        {
            throw new NotImplementedException();
        }
    }
