namespace AilosInfra.Interfaces.Mappers.AutoMapper.Mapper
{
        ...
        where Origin : class
    {
        ...
        Task<List<Origin>> MapperItemToListAsync(Destiny? item);
        Task<List<Destiny>> MapperItemToListAsync(Origin? item);
    }
}
